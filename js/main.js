...
function addRepos(repos) {
  ...
  $("<a>").attr("href", "https://github.com/MonsantoCo").text((repos.length - forks) + " public repositories").appendTo(stats);
...
function addRepo(i, repo) {
  ...
  $("<span>").addClass("description").text(repo.description).appendTo(a);
